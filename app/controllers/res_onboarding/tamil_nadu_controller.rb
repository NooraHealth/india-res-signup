# this controller will be the one that orchestrates all actions to do with RES in Tamil Nadu
...
module ResOnboarding
  class TamilNaduController < ResOnboarding::Base
    ...
    def initiate_logger
      self.logger = Logger.new("#{Rails.root}/log/tamil_nadu/#{action_name}.log")
      self.logger.info("-------------------------------------")
