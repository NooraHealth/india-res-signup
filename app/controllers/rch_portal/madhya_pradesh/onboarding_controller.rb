  ...
  module MadhyaPradesh
    class OnboardingController < ApplicationController
      ...
      def check_import_status
        ...
        render status: 200, template: 'rch_portal/madhya_pradesh/check_import_status'
      end
      ...
      def initiate_logger
        self.logger = Logger.new("#{Rails.root}/log/rch/madhya_pradesh/#{action_name}.log")
        self.logger.info("-------------------------------------")
